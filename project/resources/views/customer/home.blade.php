    ...
    <section class="container-xxl my-4">
        <section class="row">
                    ...
                    @foreach($slideShows as $slideShow)
                        <section class="item">
                            <a class="w-100 d-block h-auto text-decoration-none" href="{{ urldecode($slideShow->url) }}">
                              <img class="w-100 rounded-2 d-block h-auto" src="{{ asset($slideShow->image) }}" alt="">
                            </a>
                        </section>
                    @endforeach
            ...
            <section class="col-md-4 ps-md-1 mt-2 mt-md-0">
                @foreach($topSlideShows as $topSlideShow)
                   <section class="mb-2">
                        <a href="#" class="d-block">
                            <img class="w-100 rounded-2" src="{{ asset($topSlideShow->image) }}" alt="">
                        </a>
                    </section>
                @endforeach
            </section>
