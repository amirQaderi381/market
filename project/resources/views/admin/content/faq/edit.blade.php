                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12 my-2">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm" name="answer" id="body" rows="4">{{ old('answer',$faq->answer) }}</textarea>
                                </div>
                                @error('answer')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                            ...
                            <div class="col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select id="status" class="form-control form-control-sm" name="status">
                                        <option value="0" {{ old('status',$faq->status) == 0 ? 'selected' : '' }}>غیر فعال</option>
