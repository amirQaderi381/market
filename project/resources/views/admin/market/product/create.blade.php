                    ...
                    <form action="{{ route('admin.market.product.store') }}" method="post" id="form"
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <select id="marketable" class="form-control form-control-sm" name="marketable">
                                        <option value="0" {{ old('marketable') == 0 ? 'selected' : '' }}>غیر فعال
                                        </option>
                                        <option value="1" {{ old('marketable') == 1 ? 'selected' : '' }}>فعال
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-12 border-top border-bottom py-3 mb-3">
                                ...
                                <div>
                                    <button type="button" class="btn btn-success btn-sm btn-copy">افزودن</button>
                                </div>
                            </div>
                        </div>
