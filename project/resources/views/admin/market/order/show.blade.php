                ...
                <section class="table-responsive" id="printable">
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col" class="width-16-rem text-center"><i class="fas fa-cogs"></i> تنظیمات</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>نام مشتری</th>
                                <td class="text-left font-weight-bold">{{ $order->user->fullName ?? '_'}}</td>
                            </tr>

                            <tr>
                                <th>آدرس</th>
                                <td class="text-left font-weight-bold">{{ $order->address->address ?? '_' }}</td>
                            </tr>
                            ...
                            <tr>
                                <th>شهر</th>
                                <td class="text-left font-weight-bold">{{ $order->address->city->name ?? '_'}}</td>
                            </tr>

                            <tr>
                                <th>کد پستی</th>
                                <td class="text-left font-weight-bold">{{ $order->address->postal_code ?? '_' }}</td>
                            </tr>
